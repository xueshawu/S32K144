...
#define DEM_EVENT_ID_LAST_VALID_ID              (20U)

#define DEM_MAX_NR_OF_DIDS_IN_FREEZEFRAME_DATA	(50)

#define DEM_DID_IDENTIFIER_SIZE_OF_BYTES		(20)

#define DEM_HIGHEST_FF_REC_NUM                  (2)

#define DEM_HIGHEST_EXT_DATA_REC_NUM			(3)
