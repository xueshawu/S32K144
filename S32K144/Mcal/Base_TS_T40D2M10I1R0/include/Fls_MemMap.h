...
==================================================================================================*/
/*
* @violates @ref Fls_MemMap_h_REF_2 Precautions shall be taken in order
...
/**************************************** FLS *******************************/
    ...
    /**
    * @file Fls_MemMap.h
    * @violates @ref Fls_MemMap_h_REF_1 MISRA 2004 Required Rule 19.6, use of '#undef' is discouraged
    */
