...
==================================================================================================*/
/*
* @violates @ref Fee_MemMap_h_REF_2 Precautions shall be taken in order
...
#define FEE_MEMMAP_AR_RELEASE_MINOR_VERSION     3
#define FEE_MEMMAP_AR_RELEASE_REVISION_VERSION  1
...
/**************************************** FEE *******************************/
    ...
    /**
    * @file Fee_MemMap.h
    * @violates @ref Fee_MemMap_h_REF_1 MISRA 2004 Required Rule 19.6, use of '#undef' is discouraged
    */
