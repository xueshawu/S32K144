...
==================================================================================================*/
/*
 * @violates @ref Fr_GeneralTypes_h_REF_2 precautions to prevent the
 * contents of a header file being included twice  */
#include "Std_Types.h"
...
/* @violates @ref Fr_GeneralTypes_h_REF_1 */
...
* @implements Fr_TxLPduStatusType_enumeration
*/
typedef enum
{
    FR_TRANSMITTED = 0U,    /* No LPdu transmission is pending and no TX conflict occurred, LSdu has been transmitted.*/
    FR_NOT_TRANSMITTED,     /* An LPdu transmission is pending, LSdu has not been transmitted.*/
    FR_TRANSMITTED_CONFLICT /* No LPdu transmission is pending and TX conflict occurred, A transmission conflict has occurred.*/
} Fr_TxLPduStatusType;

/**
* @enum Fr_RxLPduStatusType
* @brief Transmit resource status is stored to variable of this type
* @implements Fr_RxLPduStatusType_enumeration
*/
typedef enum
{
...
* @implements Fr_POCStateType_enumeration
*/
typedef enum
{
...
* @implements Fr_SlotModeType_enumeration
*/
typedef enum
{
...
* @implements Fr_ErrorModeType_enumeration
*/
typedef enum
{
...
* @implements Fr_WakeupStatusType_enumeration
*/
typedef enum
{
...
* @implements Fr_StartupStateType_enumeration
*/
typedef enum
{
...
* @implements Fr_ChannelType_enumeration
*/
typedef enum
{
