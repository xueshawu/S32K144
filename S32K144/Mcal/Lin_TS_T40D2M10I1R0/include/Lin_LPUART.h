...
* external identifiers.
*/
#define LIN_LPUART_AR_RELEASE_MINOR_VERSION     3
/**
* @violates @ref Lin_LPUART_h_REF_2 The compiler/linker shall be checked to
* ensure that 31 character significance and case sensitivity are supported for
* external identifiers.
*/
#define LIN_LPUART_AR_RELEASE_REVISION_VERSION  1
...
*
*/
#define LPUART_MAX_DATA_LENGTH_U8                  ((uint8)LIN_MAX_DATA_LENGTH)
/**
* @brief        Maximum Length of Buffer (Sync(1), Pid(1), Data bytes and Checksum(1)).
*
*/
#define LPUART_MAX_BUFFER_LENGTH_U8                ((uint8)LIN_MAX_DATA_LENGTH+(uint8)3U)
...
* external identifiers.
*/
#define LPUART_MASTER_REQUEST_DIAGNOSTIC_ID_U8     ((uint8)0x3CU)
...
* external identifiers.
*/
#define LPUART_MASTER_REQUEST_DIAGNOSTIC_PID_U8     ((uint8)0x3CU)
...
* external identifiers.
*/
#define LPUART_SLAVE_RESPONSE_DIAGNOSTIC_PID_U8     ((uint8)0x7DU)
