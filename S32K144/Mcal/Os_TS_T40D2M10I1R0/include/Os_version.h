...
#define OS_AR_RELEASE_MINOR_VERSION     3   /* Minor version number of AUTOSAR specification       */
#define OS_AR_RELEASE_REVISION_VERSION  1   /* Patch level version number of AUTOSAR specification */
