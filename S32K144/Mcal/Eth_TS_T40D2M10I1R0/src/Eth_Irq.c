...
==================================================================================================*/
    LOCAL_INLINE void Eth_RxIrqHdlr (CONST(uint8, AUTOMATIC) u8CtrlIdx, CONST(uint8, AUTOMATIC) u8QueueIdx);
    LOCAL_INLINE void Eth_TxIrqHdlr (CONST(uint8, AUTOMATIC) u8CtrlIdx, CONST(uint8, AUTOMATIC) u8QueueIdx);
    #if defined(ETH_COMBINED_IRQ_SCR) && (STD_ON == ETH_COMBINED_IRQ_SCR)
    LOCAL_INLINE void Eth_TxRxIrqHdlr (CONST(uint8, AUTOMATIC) u8CtrlIdx, CONST(uint8, AUTOMATIC) u8QueueIdx);
#endif
...

{
    if(ETH_STATE_INIT != Eth_CtrlState[u8CtrlIdx])
    {
        ...
        Eth_Ipw_ClearRxInterruptFlag(u8CtrlIdx, u8QueueIdx);

    }
    else
    {
        /* Check whether the interrupt flag is set */
        if((VAR(boolean, AUTOMATIC))TRUE == Eth_Ipw_IsRxInterruptFlagSet(u8CtrlIdx, u8QueueIdx))
        {    
            /* Check whether the interrupt is enabled */
            if((VAR(boolean, AUTOMATIC))TRUE == Eth_Ipw_IsRxInterruptEnabled(u8CtrlIdx, u8QueueIdx))
            {   /* The interrupt flag is set and the interrupt is enabled, 
                ...
                (void)Eth_Ipw_ReportReception(u8CtrlIdx, u8QueueIdx, (VAR(boolean, AUTOMATIC))TRUE);
            }
        }
        ...
        Eth_Ipw_ClearRxInterruptFlag(u8CtrlIdx, u8QueueIdx); /* Clear the interrupt flag */
...
LOCAL_INLINE void Eth_TxIrqHdlr (CONST(uint8, AUTOMATIC) u8CtrlIdx, CONST(uint8, AUTOMATIC) u8QueueIdx)
{
    ...
    bIrqFlagState = Eth_Ipw_IsTxInterruptFlagSet(u8CtrlIdx, u8QueueIdx);
    Eth_Ipw_ClearTxInterruptFlag(u8CtrlIdx, u8QueueIdx); /* Clear the interrupt flag */
    ...
    if(ETH_STATE_INIT == Eth_CtrlState[u8CtrlIdx])
    {
        ...
        {    
            /* Check whether the interrupt is enabled */
            if((VAR(boolean, AUTOMATIC))TRUE == Eth_Ipw_IsTxInterruptEnabled(u8CtrlIdx, u8QueueIdx))
            {   /* The interrupt flag is set and the interrupt is enabled, 
                proceed with the handler */
...
LOCAL_INLINE void Eth_TxRxIrqHdlr (CONST(uint8, AUTOMATIC) u8CtrlIdx, CONST(uint8, AUTOMATIC) u8QueueIdx)
{
...
#if (STD_ON == ETH_GLOBALTIME_SUPPORT)
    VAR(boolean, AUTOMATIC) bTimerIrqFlagState;
#endif /* (STD_ON == ETH_GLOBALTIME_SUPPORT) */
    /* Hold TXF locally */
    bTxIrqFlagState = Eth_Ipw_IsTxInterruptFlagSet(u8CtrlIdx, u8QueueIdx);
    if ((VAR(boolean, automatic))TRUE == bTxIrqFlagState)
    {
        ...
        * to prevent flag vanishing of next queued interrupt */
        Eth_Ipw_ClearTxInterruptFlag(u8CtrlIdx, u8QueueIdx);
    }
    /* Hold RXF locally */
    bRxIrqFlagState = Eth_Ipw_IsRxInterruptFlagSet(u8CtrlIdx, u8QueueIdx);
...
#if (STD_ON == ETH_GLOBALTIME_SUPPORT)
    /* Hold TS_TIMER locally */
    bTimerIrqFlagState = Eth_IPW_IsTimerWrapEvent(u8CtrlIdx);
    if ((VAR(boolean, automatic))TRUE == bTimerIrqFlagState)
    {
        /* Clear TS_TIMER as soon as possible after function entry
        * to prevent flag vanishing of next queued interrupt */
...
void Eth_RxIrqHdlr_0(CONST(uint8, AUTOMATIC) u8QueueIdx)
{
    Eth_RxIrqHdlr((uint8)0U, u8QueueIdx);
    /**
...
* @violates @ref Eth_Irq_c_REF_5 MISRA 2004 Rule 8.10
*/
void Eth_TxIrqHdlr_0(CONST(uint8, AUTOMATIC) u8QueueIdx)
{
    Eth_TxIrqHdlr((uint8)0U, u8QueueIdx);
    /**
     * @violates @ref Eth_Irq_c_REF_4 MISRA rule 11.1
     */
    /* EXIT_INTERRUPT(); */
...
void Eth_TxRxIrqHdlr_0(CONST(uint8, AUTOMATIC) u8QueueIdx)
{
    Eth_TxRxIrqHdlr((uint8)0U, u8QueueIdx);
    /**
     * @violates @ref Eth_Irq_c_REF_4 MISRA rule 11.1
     */
    /* EXIT_INTERRUPT(); */
...
* @violates @ref Eth_Irq_c_REF_5 MISRA 2004 Rule 8.10
*/
void Eth_RxIrqHdlr_1(CONST(uint8, AUTOMATIC) u8QueueIdx)
{
    Eth_RxIrqHdlr((uint8)1U, u8QueueIdx);
    /**
     * @violates @ref Eth_Irq_c_REF_4 MISRA rule 11.1
     */
    /* EXIT_INTERRUPT(); */
...
void Eth_TxIrqHdlr_1(CONST(uint8, AUTOMATIC) u8QueueIdx)
{
    Eth_TxIrqHdlr((uint8)1U, u8QueueIdx);
    /**
     * @violates @ref Eth_Irq_c_REF_4 MISRA rule 11.1
     */
    /* EXIT_INTERRUPT(); */
...
* @violates @ref Eth_Irq_c_REF_5 MISRA 2004 Rule 8.10
*/
void Eth_TxRxIrqHdlr_1(CONST(uint8, AUTOMATIC) u8QueueIdx)
{
    Eth_TxRxIrqHdlr((uint8)1U, u8QueueIdx);
    /**
     * @violates @ref Eth_Irq_c_REF_4 MISRA rule 11.1
     */
    /* EXIT_INTERRUPT(); */
