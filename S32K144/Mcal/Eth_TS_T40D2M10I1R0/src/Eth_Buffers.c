...
/** @violates @ref Eth_Buffers_c_REF_5 MISRA rule 8.10 */
    VAR_ALIGN(VAR(uint8, ETH_VAR) Eth_TxBuffers0[ETH_MAX_CONTROLLER_CFG][ETH_TX_BUF_0_MEM_SIZE], ETH_TX_BUF_ALIGNMENT)
ALIGNED_VARS_STOP()
...
/** @violates @ref Eth_Buffers_c_REF_5 MISRA rule 8.10 */
    VAR_ALIGN(VAR(uint8, ETH_VAR) Eth_RxBuffers0[ETH_MAX_CONTROLLER_CFG][ETH_RX_BUF_0_MEM_SIZE], ETH_RX_BUF_ALIGNMENT)
ALIGNED_VARS_STOP()
