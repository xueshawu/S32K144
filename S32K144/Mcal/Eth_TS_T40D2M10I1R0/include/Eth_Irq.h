...
/** @violates @ref Eth_Irq_h_REF_1 MISRA rule 1.4 
* @violates @ref Eth_Irq_h_REF_3 MISRA rule 5.1 */
#define ETH_AR_RELEASE_MINOR_VERSION_ETHIRQ     3
/** @violates @ref Eth_Irq_h_REF_1 MISRA rule 1.4 
* @violates @ref Eth_Irq_h_REF_3 MISRA rule 5.1 */
#define ETH_AR_RELEASE_REVISION_VERSION_ETHIRQ  1
...
#include "Eth_MemMap.h"
    ...
    extern void Eth_TxIrqHdlr_0(CONST(uint8, AUTOMATIC) u8QueueIdx);
    extern void Eth_RxIrqHdlr_0(CONST(uint8, AUTOMATIC) u8QueueIdx);
    /* This function is used only in ARM platform which does not have separated IRQ vectors */
#if defined(ETH_COMBINED_IRQ_SCR) && (STD_ON == ETH_COMBINED_IRQ_SCR)
    extern void Eth_TxRxIrqHdlr_0(CONST(uint8, AUTOMATIC) u8QueueIdx);
#endif

#if (1U < ETH_MAXCTRLS_SUPPORTED)
    extern void Eth_TxIrqHdlr_1(CONST(uint8, AUTOMATIC) u8QueueIdx);
    extern void Eth_RxIrqHdlr_1(CONST(uint8, AUTOMATIC) u8QueueIdx);
    /* This function is used only in ARM platform which does not have separated IRQ vectors */
#if defined(ETH_COMBINED_IRQ_SCR) && (STD_ON == ETH_COMBINED_IRQ_SCR)
    extern void Eth_TxRxIrqHdlr_1(CONST(uint8, AUTOMATIC) u8QueueIdx);
#endif
