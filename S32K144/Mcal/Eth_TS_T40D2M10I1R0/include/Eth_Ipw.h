...
/** @violates @ref Eth_Ipw_h_REF_3 MISRA rule 1.4 
* @violates @ref Eth_Ipw_h_REF_4 MISRA rule 5.1 */
#define ETH_AR_RELEASE_MINOR_VERSION_ETHIPW_H     3
/** @violates @ref Eth_Ipw_h_REF_3 MISRA rule 1.4 
* @violates @ref Eth_Ipw_h_REF_4 MISRA rule 5.1 */
#define ETH_AR_RELEASE_REVISION_VERSION_ETHIPW_H  1
...
#endif
extern FUNC(void, ETH_CODE) Eth_Ipw_ClearRxInterruptFlag (CONST(uint8, AUTOMATIC) u8CtrlIdx, CONST(uint8, AUTOMATIC) u8QueueIdx);
extern FUNC(void, ETH_CODE) Eth_Ipw_ClearTxInterruptFlag (CONST(uint8, AUTOMATIC) u8CtrlIdx, CONST(uint8, AUTOMATIC) u8QueueIdx);
extern FUNC(boolean, ETH_CODE) Eth_Ipw_IsTxInterruptFlagSet (CONST(uint8, AUTOMATIC) u8CtrlIdx, CONST(uint8, AUTOMATIC) u8QueueIdx);
extern FUNC(boolean, ETH_CODE) Eth_Ipw_IsRxInterruptFlagSet (CONST(uint8, AUTOMATIC) u8CtrlIdx, CONST(uint8, AUTOMATIC) u8QueueIdx);
extern FUNC(boolean, ETH_CODE) Eth_Ipw_IsTxInterruptEnabled (CONST(uint8, AUTOMATIC) u8CtrlIdx, CONST(uint8, AUTOMATIC) u8QueueIdx);
extern FUNC(boolean, ETH_CODE) Eth_Ipw_IsRxInterruptEnabled (CONST(uint8, AUTOMATIC) u8CtrlIdx, CONST(uint8, AUTOMATIC) u8QueueIdx);
/***************************************************************************
* ETH_LLD Real Functions Prototypes
***************************************************************************/
extern FUNC(boolean, ETH_CODE) Eth_Ipw_ReportTransmission(CONST(uint8, AUTOMATIC) u8CtrlIdx);
extern FUNC(Eth_RxStatusType, ETH_CODE) Eth_Ipw_ReportReception( \
                                                    CONST(uint8, AUTOMATIC) u8CtrlIdx, \
...
extern FUNC(Eth_BufIdxType, ETH_CODE) Eth_Ipw_GetTxBufNumber ( \
                CONST(uint8, AUTOMATIC) u8CtrlIdx, \
                VAR(uint8, AUTOMATIC) u8QueueIdx \
                                                );
#endif /* ETH_USE_MULTIBUFFER_TX_FRAMES */                                                 

extern FUNC(uint32, ETH_CODE) Eth_Ipw_GetTxBufLength ( \
                CONST(uint8, AUTOMATIC) u8CtrlIdx, \
                VAR(uint8, AUTOMATIC) u8QueueIdx
                                                );
