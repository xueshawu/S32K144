...
* @file           Reg_eSys_LPspi.h
*/
#define REG_ESYS_LPSPI_VENDOR_ID_REGFLEX                    43
/**
...
*/
#define REG_ESYS_LPSPI_AR_RELEASE_MAJOR_VERSION_REGFLEX     4
/**
* @violates @ref Reg_eSys_FlexIO_h_REF_2 The compiler/linker shall be checked to
* ensure that 31 character significance and case sensitivity are supported for
* external identifiers.
*/
#define REG_ESYS_LPSPI_AR_RELEASE_MINOR_VERSION_REGFLEX     3
/**
* @violates @ref Reg_eSys_FlexIO_h_REF_2 The compiler/linker shall be checked to
* ensure that 31 character significance and case sensitivity are supported for
* external identifiers.
*/
#define REG_ESYS_LPSPI_AR_RELEASE_REVISION_VERSION_REGFLEX  1
#define REG_ESYS_LPSPI_SW_MAJOR_VERSION_REGFLEX             1
#define REG_ESYS_LPSPI_SW_MINOR_VERSION_REGFLEX             0
#define REG_ESYS_LPSPI_SW_PATCH_VERSION_REGFLEX             1
...
==================================================================================================*/
  ...
  #if ((REG_ESYS_LPSPI_AR_RELEASE_MAJOR_VERSION_REGFLEX != REG_ESYS_AR_RELEASE_MAJOR_VERSION) || \
       (REG_ESYS_LPSPI_AR_RELEASE_MINOR_VERSION_REGFLEX != REG_ESYS_AR_RELEASE_MINOR_VERSION))
  ...
  #if ((REG_ESYS_LPSPI_AR_RELEASE_MAJOR_VERSION_REGFLEX != STDREGMACROS_AR_RELEASE_MAJOR_VERSION) || \
       (REG_ESYS_LPSPI_AR_RELEASE_MINOR_VERSION_REGFLEX != STDREGMACROS_AR_RELEASE_MINOR_VERSION))
...
#define LPSPI_CFGR1_PINCFG_SIN_INPUT_SOUT_OUTPUT_U32    ((uint32)0x00000000u) /* SIN is used for input data and SOUT for output data */
#define LPSPI_CFGR1_PINCFG_SOUT_INPUT_OUTPUT_U32        ((uint32)0x02000000u) /* SOUT is used for both input and output data */
#define LPSPI_CFGR1_PINCFG_SIN_INPUT_OUTPUT_U32         ((uint32)0x01000000u) /* SIN is used for both input and output data */
#define LPSPI_CFGR1_PINCFG_SOUT_INPUT_SIN_OUTPUT_U32    ((uint32)0x03000000u) /* SOUT is used for input data and SIN for output data */
...
#define LPSPI_TCR_CONTC_EN_U32            ((uint32)0x00100000u) /* Command word for continuing transfer */
