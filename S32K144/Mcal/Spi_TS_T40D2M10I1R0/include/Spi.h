...
typedef struct
{
    /**< @brief Define HWUnit type of sequense */
    VAR(uint8, SPI_VAR) u8HWtypeOfSequence;
...
typedef struct
{
    ...
    P2CONST(Spi_Ipw_DeviceAttributesConfigType, SPI_VAR, SPI_APPL_CONST) ExternalDeviceAttrs;
} Spi_JobConfigType;
...
typedef struct
{
    ...
    VAR(uint32, SPI_VAR) u32DefaultTransmitValue;
    /**< @brief Data length. */
...
typedef struct
{
    ...
    VAR(Spi_ModeType, SPI_VAR) eSpiPhyUnitMode;
    ...
    /**< @brief FlexIO TX */
    VAR(uint8, SPI_VAR) u8spiFlexIO_TX;
    /**< @brief FlexIO RX */
    VAR(uint8, SPI_VAR) u8spiFlexIO_RX;
    /**< @brief FlexIO Clock */
    VAR(uint8, SPI_VAR) u8spiFlexIO_CLK;
    /**< @brief FlexIO Chip Select */
    VAR(uint8, SPI_VAR) u8spiFlexIO_CS;
#endif
#endif
