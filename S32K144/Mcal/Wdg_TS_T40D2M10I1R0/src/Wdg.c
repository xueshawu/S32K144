...
/** @violates @ref Wdg_C_REF_2 MISRA 2004 Rule 1.4 */
/** @violates @ref Wdg_C_REF_3 MISRA 2004 Rule 5.1 */
#define WDG_AR_RELEASE_MINOR_VERSION_C     3
/** @violates @ref Wdg_C_REF_2 MISRA 2004 Rule 1.4 */
/** @violates @ref Wdg_C_REF_3 MISRA 2004 Rule 5.1 */
#define WDG_AR_RELEASE_REVISION_VERSION_C  1
#define WDG_SW_MAJOR_VERSION_C             1
#define WDG_SW_MINOR_VERSION_C             0
#define WDG_SW_PATCH_VERSION_C             1
...
#if ((WDG_AR_RELEASE_MAJOR_VERSION_C    != WDG_AR_RELEASE_MAJOR_VERSION) || \
     (WDG_AR_RELEASE_MINOR_VERSION_C    != WDG_AR_RELEASE_MINOR_VERSION) || \
