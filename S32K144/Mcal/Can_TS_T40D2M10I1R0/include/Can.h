...
#endif
/* Check if current file and Can configuration header file are of the same module */
#if (CAN_MODULE_ID != CAN_MODULE_ID_CFG)
#error "Can.h and Can_Cfg.h have different module ids"
#endif
...
/**
* @brief          Can_Busy
* @details        CAN_BUSY return from Functions.
*                 Return state of CAN_BUSY.
*/

#define        CAN_BUSY  (0x02U)      /**< @brief Operation was rejected because of busy state */
/*==================================================================================================
*                                             ENUMS
==================================================================================================*/
...
#endif
        CONST(boolean, CAN_CONST) CanHwObjectUsesPolling; /**< @brief The parameter is used to detect the MB which is use Polling or Interrupt */
...
extern FUNC(Std_ReturnType, CAN_CODE) Can_GetControllerMode( VAR(uint8, AUTOMATIC) Controller, P2VAR(Can_ControllerStateType, AUTOMATIC, CAN_APPL_DATA) ControllerModePtr);

extern FUNC(Std_ReturnType, CAN_CODE) Can_GetControllerErrorState( VAR(uint8, AUTOMATIC) ControllerId, P2VAR(Can_ErrorStateType, AUTOMATIC, CAN_APPL_DATA) ErrorStatePtr);
...
extern FUNC(Std_ReturnType, CAN_CODE) Can_SetControllerMode( VAR(uint8, AUTOMATIC) Controller,
...
extern FUNC(Std_ReturnType, CAN_CODE) Can_Write( VAR(Can_HwHandleType, AUTOMATIC) Hth,
                                                 P2CONST(Can_PduType, AUTOMATIC, CAN_APPL_CONST) PduInfo
                                               );

extern FUNC (Std_ReturnType, CAN_CODE) Can_CheckWakeup( VAR(uint8, AUTOMATIC) controller);
