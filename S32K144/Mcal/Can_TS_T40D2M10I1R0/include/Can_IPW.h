...
#define CAN_IPW_AR_RELEASE_MINOR_VERSION_H     3
#define CAN_IPW_AR_RELEASE_REVISION_VERSION_H  1
...
#if (CAN_IPW_VENDOR_ID_H != CAN_FLEXCAN_VENDOR_ID_H)
#error "Can_IPW.h and Can_Flexcan.h have different vendor ids"
#endif
/* Check if current file and Reg_eSys_FlexCan.h file are of the same module */
#if (CAN_IPW_MODULE_ID_H != CAN_FLEXCAN_MODULE_ID_H)
#error "Can_IPW.h and Can_Flexcan.h have different module ids"
#endif
/* Check if current file and Reg_eSys_FlexCan.h file are of the same Autosar version */
#if ((CAN_IPW_AR_RELEASE_MAJOR_VERSION_H != CAN_FLEXCAN_AR_RELEASE_MAJOR_VERSION_H) || \
     (CAN_IPW_AR_RELEASE_MINOR_VERSION_H != CAN_FLEXCAN_AR_RELEASE_MINOR_VERSION_H) || \
     (CAN_IPW_AR_RELEASE_REVISION_VERSION_H != CAN_FLEXCAN_AR_RELEASE_REVISION_VERSION_H))
  #error "AutoSar Version Numbers of Can_IPW.h and Can_Flexcan.h are different"
#endif
/* Check if current file and Reg_eSys_FlexCan.h file are of the same Software version */
#if ((CAN_IPW_SW_MAJOR_VERSION_H != CAN_FLEXCAN_SW_MAJOR_VERSION_H) || \
     (CAN_IPW_SW_MINOR_VERSION_H != CAN_FLEXCAN_SW_MINOR_VERSION_H) || \
     (CAN_IPW_SW_PATCH_VERSION_H != CAN_FLEXCAN_SW_PATCH_VERSION_H))
       #error "Software Version Numbers of Can_IPW.h and Can_Flexcan.h are different"
#endif
...
/* @violates @ref CAN_IPW_h_REF_3 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */
/* @violates @ref CAN_IPW_h_REF_5 MISRA 2004 Required Rule 19.4, C macros shall only expand to a braced initialiser,  a constant, a parenthesised expression */
        #define        Can_IPW_DeInitController(Controller)                             Mcal_Trusted_Call1param(Can_FlexCan_DeInitController,(Controller))
#else                                          
/* @violates @ref CAN_IPW_h_REF_3 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */
/* @violates @ref CAN_IPW_h_REF_5 MISRA 2004 Required Rule 19.4, C macros shall only expand to a braced initialiser,  a constant, a parenthesised expression */
        #define        Can_IPW_DeInitController(Controller)                          (Can_FlexCan_DeInitController(Controller))
#endif
#if (STD_ON == CAN_ENABLE_USER_MODE_SUPPORT)
/* @violates @ref CAN_IPW_h_REF_3 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */
/* @violates @ref CAN_IPW_h_REF_5 MISRA 2004 Required Rule 19.4, C macros shall only expand to a braced initialiser,  a constant, a parenthesised expression */
...
#endif
/* @violates @ref CAN_IPW_h_REF_3 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */
#define Can_IPW_GetControllerErrorState(controller)                                                         (Can_FlexCan_GetControllerErrorState( controller))
/*==================================================================================================
*                                             ENUMS
==================================================================================================*/
