...
#define CAN_AR_RELEASE_MINOR_VERSION_REGFLEX     3
#define CAN_AR_RELEASE_REVISION_VERSION_REGFLEX  1
...
==================================================================================================*/
    ...
    #if ((CAN_AR_RELEASE_MAJOR_VERSION_REGFLEX != REG_ESYS_AR_RELEASE_MAJOR_VERSION) || \
        (CAN_AR_RELEASE_MINOR_VERSION_REGFLEX != REG_ESYS_AR_RELEASE_MINOR_VERSION))
        #error "AutoSar Version Numbers of Reg_eSys_FlexCan.h and Reg_eSys.h are different"
    #endif
#endif
/*==================================================================================================
*                                          CONSTANTS
...
#define CAN_CONTROLLERCONFIG_RXINT_EN_U32       ((uint32)0x00040000U)
#define CAN_CONTROLLERCONFIG_TXINT_EN_U32       ((uint32)0x00080000U)
...
/*==================================================================================================
                BIT MASKS FOR SHIFTING ERROR AND STATUS REGISTER VALUES
==================================================================================================*/
/**
* @brief The value of each field in error and status register
*/
/* The value of ESR[FLTCONF] */
#define FLEXCAN_ESR_FLTCONF_ERROR_ACTIVE_U32                ((uint32)0x00000000U)
#define FLEXCAN_ESR_FLTCONF_ERROR_PASSIVE_U32               ((uint32)0x00000010U)
