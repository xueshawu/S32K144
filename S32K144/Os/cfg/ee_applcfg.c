  ...
  osEE_tdb_array[7]  =
{
  ...
  },
  {
    ...
    /* .tid            = */ 2U,
    /* .task_type      = */ OSEE_TASK_TYPE_BASIC,
    /* .task_func      = */ TASK_FUNC(Task_Bsw_100Ms),
    /* .ready_prio     = */ 1U,
    /* .dispatch_prio  = */ 1U,
    /* .max_num_of_act = */ 1U
  },
  ...
  },
  {
    ...
    /* .tid            = */ 5U,
    /* .task_type      = */ OSEE_TASK_TYPE_BASIC,
    /* .task_func      = */ TASK_FUNC(Task_Asw_5Ms),
    /* .ready_prio     = */ 2U,
    /* .dispatch_prio  = */ 2U,
    /* .max_num_of_act = */ 1U
  },
...
static CONSTP2VAR(OsEE_TDB, OS_CONST, OS_APPL_DATA)
  osEE_tdb_ptr_autostart_OSDEFAULTAPPMODE[5U] =
{
  &osEE_tdb_array[1U],
  &osEE_tdb_array[2U],
  &osEE_tdb_array[3U],
...
static VAR(OsEE_AlarmCB, OS_VAR_CLEARED)
  osEE_alarm_cb_array[4];



static VAR(OsEE_AlarmDB, OS_CONST)
  osEE_alarm_db_array[4] = {
  {
  ...
  {
    /* .p_trigger_cb = */ &osEE_alarm_cb_array[3U],
    /* .p_counter_db = */ &osEE_counter_db_array[0U],
    /* .action       = */ {
      /* .param      = */   {
        /* .f            = */ NULL,
...
static VAR(OsEE_autostart_trigger_info, OS_CONST)
  osEE_trigger_autostart_info_OSDEFAULTAPPMODE[4U] =
{
  {
    /* .p_trigger_db          = */  &osEE_alarm_db_array[0U],
    /* .first_tick_parameter  = */  (2U),
  ...
  {
    /* .p_trigger_db          = */  &osEE_alarm_db_array[3U],
    /* .first_tick_parameter  = */  (5U),
    /* .first_tick_parameter  = */  (5U)
  }
};
