...
*/
#define Pwm_Rgb_Blue         ((Pwm_ChannelType)1U)
#define Pwm_Rgb_Red         ((Pwm_ChannelType)0U)

/** 
* @brief           Symbolic Names for configured channels - ecuc 2108 compliant.
*/

#define  PwmConf_PwmChannelConfigSet_Pwm_Rgb_Blue         ((Pwm_ChannelType)1U)
#define  PwmConf_PwmChannelConfigSet_Pwm_Rgb_Red         ((Pwm_ChannelType)0U)
...
#define PWM_FTM_CHANNELS_MAX_U8            (2U)
