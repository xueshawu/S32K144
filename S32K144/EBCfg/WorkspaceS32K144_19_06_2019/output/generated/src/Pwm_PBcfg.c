...
*/
#define PWM_CONF_CHANNELS_PB            ((uint8) 2U)
...
* @brief Number of configured Ftm channels 
*/
#define PWM_CONF_FTM_CHANNELS_PB         ((uint8) 2U)
...
static CONST(Pwm_Ftm_ModuleConfigType, PWM_CONST) Pwm_Ftm_ModuleConfig_PB[PWM_FTM_MOD_CONFIGS_PB] =
{
    ...
    /* Ftm Module 0 */
    {
        ...
        (FTM_SC_CLKS_SYS_CLOCK_U32 | FTM_SC_PS_DIV128_U32 |  ((uint32)1U << (FTM_SC_PWMOUTPUTEN_SHIFT + (uint32)2U ))| ((uint32)1U << (FTM_SC_PWMOUTPUTEN_SHIFT + (uint32)0U ))| ((uint32)0)),
        ...
        (FTM_COMBINE_SYNCEN1_ENABLE_U32 | FTM_COMBINE_SYNCEN0_ENABLE_U32 | ((uint32) 0)),
